...
const variantClasses = {
    primary: "bg-gradient-to-r from-accent to-accent-strong text-accent-ink shadow-[0_6px_18px_rgb(234_179_8/0.24)] hover:-translate-y-0.5 hover:shadow-[0_8px_22px_rgb(234_179_8/0.32)]",
